using GanihuhStack.Domain.Events;
using Microsoft.Extensions.Logging;

namespace GanihuhStack.Application.TodoItems.EventHandlers;
...
public class LogTodoItemCompleted : INotificationHandler<TodoItemCompletedEvent>
{
    ...
    {
        _logger.LogInformation("GanihuhStack Domain Event: {DomainEvent}", notification.GetType().Name);
